$(document).ready(function () {
    ...
    // Nice Select is optional; native selects remain usable when the plugin is absent.
    if (typeof $.fn.niceSelect === 'function' && $('.nice-control').length > 0) {
...
$(document).ready(function () {
    ...
    // Nice Select 
    if (typeof $.fn.niceSelect === 'function' && $niceSelect1.length > 0) {
...
$(document).ready(function(){
    ...
    // Nice Select 
    if (typeof $.fn.niceSelect === 'function' && $('.lms-select').length > 0) {
